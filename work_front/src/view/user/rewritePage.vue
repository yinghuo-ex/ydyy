<template>
    <div class="container">
      ...
      <div class="input-container">
        <input v-model="input1" type="text" placeholder="Article Title" class="input-field input1">
        <input v-model="input2" type="text" placeholder="What is the article about" class="input-field input2">
        <textarea v-model="input3" placeholder="Write your article" class="input-field input3"></textarea>
        <input v-model="input4" type="text" placeholder="Enter the tag" class="input-field input4">
      </div>
    </div>
  </template>
<script>
