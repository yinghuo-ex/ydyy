...
const {sign,decode} = require('../u tils/jwt')
...
module.exports.createUser = async (req,res) => {
    try{
        ...
        if(!req.body.user.image) throw new Error("image is Required")
...
module.exports.updateUserDetails = async (req,res) => {
    ...
    try{
        ...
        if(req.body.user){
            ...
            const updatedUser = await user.update({username,image,password})
